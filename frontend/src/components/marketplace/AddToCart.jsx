              ...
              <div className="mt-4">
                {item.quantity >= 1 ? (
                  <button
                    ...
                    className="w-full bg-gradient-to-r from-yellow-400 to-yellow-600 hover:from-yellow-500 hover:to-yellow-700 text-black font-bold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-105 shadow-lg shadow-yellow-500/30"
                  >
                    Buy Now - ₹{item.price}
                  </button>
                ) : (
